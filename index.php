...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-4">
                <a class="destination" href="pages/touroperators.php?destination=maroc">
    ...
    <div class="col-sm-12 col-md-4">
        <a class="destination" href="pages/touroperators.php?destination=bresil">
    ...
    <div class="col-sm-12 col-md-4">
        <a class="destination" href="pages/touroperators.php?destination=ilemaurice">
            <div class="card shadow mb-5 bg-white rounded" style="width: 18rem;">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-4">
            <a class="destination" href="pages/touroperators.php?destination=portugal">
                <div class="card shadow mb-5 bg-white rounded" style="width: 18rem;">
    ...
    <div class="col-sm-12 col-md-4">
        <a class="destination" href="pages/touroperators.php?destination=japon">
            <div class="card shadow mb-5 bg-white rounded" style="width: 18rem;">
    ...
    <div class="col-sm-12 col-md-4">
        <a class="destination" href="pages/touroperators.php?destination=usa">
            <div class="card shadow mb-5 bg-white rounded" style="width: 18rem;">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-4">
            <a class="destination" href="pages/touroperators.php?destination=france">
                <div class="card shadow mb-5 bg-white rounded" style="width: 18rem;">
    ...
    <div class="col-sm-12 col-md-4">
        <div class="card shadow mb-5 bg-white rounded" style="width: 18rem;">
            <a class="destination" href="pages/touroperators.php?destination=mexique">
    ...
    <div class="col-sm-12 col-md-4">
        <a class="destination" href="pages/touroperators.php?destination=espagne">
            <div class="card shadow mb-5 bg-white rounded" style="width: 18rem;">
